...
Component_RotationZ::Component_RotationZ(string _name, StageObject* _holder, Component* _parent)
	:Component(_holder, _name, RotationZ,_parent), angle_(0), rotateSpeed_(0)
{
}
